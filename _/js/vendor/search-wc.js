...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Gt=/'/g,Jt=/"/g,Qt=/^(?:script|style|textarea|title)$/i,Et=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),f=Et(1),kr=Et(2),Hr=Et(3),E=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),Kt=new WeakMap,H=M.createTreeWalker(M,129);function te(r,t){if(!St(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Bt!==void 0?Bt.createHTML(t):t}var ui=(r,t)=>{let e=r.length-1,i=[],s,n=t===2?"<svg>":t===3?"<math>":"",o=F;for(let l=0;l<e;l++){let a=r[l],d,g,h=-1,b=0;for(;b<a.length&&(o.lastIndex=b,g=o.exec(a),g!==null);)b=o.lastIndex,o===F?g[1]==="!--"?o=Wt:g[1]!==void 0?o=Ft:g[2]!==void 0?(Qt.test(g[2])&&(s=RegExp("</"+g[2],"g")),o=k):g[3]!==void 0&&(o=k):o===k?g[0]===">"?(o=s??F,h=-1):g[1]===void 0?h=-2:(h=o.lastIndex-g[2].length,d=g[1],o=g[3]===void 0?k:g[3]==='"'?Jt:Gt):o===Jt||o===Gt?o=k:o===Wt||o===Ft?o=F:(o=k,s=void 0);let x=o===k&&r[l+1].startsWith("/>")?" ":"";n+=o===F?a+hi:h>=0?(i.push(d),a.slice(0,h)+Xt+a.slice(h)+C+x):a+C+(h===-2?l:x)}return[te(r,n+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},K=class r{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,o=0,l=t.length-1,a=this.parts,[d,g]=ui(t,e);if(this.el=r.createElement(d,i),H.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=H.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(let h of s.getAttributeNames())if(h.endsWith(Xt)){let b=g[o++],x=s.getAttribute(h).split(C),R=/([.?@])?(.*)/.exec(b);a.push({type:1,index:n,name:R[2],strings:x,ctor:R[1]==="."?yt:R[1]==="?"?bt:R[1]==="@"?$t:U}),s.removeAttribute(h)}else h.startsWith(C)&&(a.push({type:6,index:n}),s.removeAttribute(h));if(Qt.test(s.tagName)){let h=s.textContent.split(C),b=h.length-1;if(b>0){s.textContent=lt?lt.emptyScript:"";for(let x=0;x<b;x++)s.append(h[x],G()),H.nextNode(),a.push({type:2,index:++n});s.append(h[b],G())}}}else if(s.nodeType===8)if(s.data===Yt)a.push({type:2,index:n});else{let h=-1;for(;(h=s.data.indexOf(C,h+1))!==-1;)a.push({type:7,index:n}),h+=C.length-1}n++}}static createElement(t,e){let i=M.createElement("template");return i.innerHTML=t,i}};function N(r,t,e=r,i){if(t===E)return t;let s=i!==void 0?e._$Co?.[i]:e._$Cl,n=J(t)?void 0:t._$litDirective$;return s?.constructor!==n&&(s?._$AO?.(!1),n===void 0?s=void 0:(s=new n(r),s._$AT(r,e,i)),i!==void 0?(e._$Co??=[])[i]=s:e._$Cl=s),s!==void 0&&(t=N(r,s._$AS(r,t.values),s,i)),t}var _t=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??M).importNode(e,!0);H.currentNode=s;let n=H.nextNode(),o=0,l=0,a=i[0];for(;a!==void 0;){if(o===a.index){let d;a.type===2?d=new X(n,n.nextSibling,this,t):a.type===1?d=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(d=new xt(n,this,t)),this._$AV.push(d),a=i[++l]}o!==a?.index&&(n=H.nextNode(),o++)}return H.currentNode=M,s}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},X=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=N(this,t,e),J(t)?t===p||t==null||t===""?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==E&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ci(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==p&&J(this._$AH)?this._$AA.nextSibling.data=t:this.T(M.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,s=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=K.createElement(te(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let n=new _t(s,this),o=n.u(this.options);n.p(e),this.T(o),this._$AH=n}}_$AC(t){let e=Kt.get(t.strings);return e===void 0&&Kt.set(t.strings,e=new K(t)),e}k(t){St(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let n of t)s===e.length?e.push(i=new r(this.O(G()),this.O(G()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let i=t.nextSibling;t.remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},U=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,n){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=p}_$AI(t,e=this,i,s){let n=this.strings,o=!1;if(n===void 0)t=N(this,t,e,0),o=!J(t)||t!==this._$AH&&t!==E,o&&(this._$AH=t);else{let l=t,a,d;for(t=n[0],a=0;a<n.length-1;a++)d=N(this,l[i+a],e,a),d===E&&(d=this._$AH[a]),o||=!J(d)||d!==this._$AH[a],d===p?t=p:t!==p&&(t+=(d??"")+n[a+1]),this._$AH[a]=d}o&&!s&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},yt=class extends U{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}},bt=class extends U{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==p)}},$t=class extends U{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){if((t=N(this,t,e,0)??p)===E)return;let i=this._$AH,s=t===p&&i!==p||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==p&&(i===p||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},xt=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){N(this,t)}};var di=At.litHtmlPolyfillSupport;di?.(K,X),(At.litHtmlVersions??=[]).push("3.2.1");var ee=(r,t,e)=>{let i=e?.renderBefore??t,s=i._$litPart$;if(s===void 0){let n=e?.renderBefore??null;i._$litPart$=s=new X(t.insertBefore(G(),n),n,void 0,e??{})}return s._$AI(r),s};var $=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=ee(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return E}};$._$litElement$=!0,$.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:$});var pi=globalThis.litElementPolyfillSupport;pi?.({LitElement:$});(globalThis.litElementVersions??=[]).push("4.1.1");var V=r=>(t,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(r,t)}):customElements.define(r,t)};var gi={attribute:!0,type:String,converter:W,reflect:!1,hasChanged:at},mi=(r=gi,t,e)=>{let{kind:i,metadata:s}=e,n=globalThis.litPropertyMetadata.get(s);if(n===void 0&&globalThis.litPropertyMetadata.set(s,n=new Map),n.set(e.name,r),i==="accessor"){let{name:o}=e;return{set(l){let a=t.get.call(this);t.set.call(this,l),this.requestUpdate(o,a,r)},init(l){return l!==void 0&&this.P(o,void 0,r),l}}}if(i==="setter"){let{name:o}=e;return function(l){let a=this[o];t.call(this,l),this.requestUpdate(o,a,r)}}throw Error("Unsupported decorator location: "+i)};function u(r){return(t,e)=>typeof e=="object"?mi(r,t,e):((i,s,n)=>{let o=s.hasOwnProperty(n);return s.constructor.createProperty(n,o?{...i,wrapped:!0}:i),o?Object.getOwnPropertyDescriptor(s,n):void 0})(r,t,e)}function Y(r){return u({...r,state:!0,attribute:!1})}var z=(r,t,e)=>(e.configurable=!0,e.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(r,t,e),e);var fi;function ie(r){return(t,e)=>z(t,e,{get(){return(this.renderRoot??(fi??=document.createDocumentFragment())).querySelectorAll(r)}})}var Pe=Rt(Tt());var ut="qs-start",P="qs-result",ht="qs-next-page",ct="qs-query-suggestion",_=class extends ${constructor(){super();this.server="";this.minChars=3;this.initialTimeout=1500;this.moreTimeout=2500;this.language="en";this.localSearch=!1;this.originFilter="";this._page=0;this._currentHitCount=0;this._abortController=null;this._search=()=>{if(this._abortController&&this._abortController.abort(),!this._backendData){this._clearSearch();return}let e=new AbortController;if(this._abortController=e,this.dispatchEvent(new CustomEvent(ut,{detail:{page:this._page}})),this.localSearch){this._localSearch(),this._abortController==e&&(this._abortController=null);return}this._jsonFetch(e,"GET",this._backendData,this._page>0?this.initialTimeout:this.moreTimeout).then(i=>{this._page>0?this._currentHitCount+=i.hits.length:this._currentHitCount=i.hits.length;let s=i.total?.lowerBound,n=i.hits.length>0&&s>this._currentHitCount;this.dispatchEvent(new CustomEvent(P,{detail:{...i,search:this._backendData,page:this._page,hasMoreHits:n}}))}).catch(i=>{console.error("Could not run search: "+i),this._abortController==e&&(this._page=0,this._currentHitCount=0,this._localSearch())}).finally(()=>{this._abortController==e&&(this._abortController=null)})};this._searchDebounced=(0,Pe.default)(this._search,300);this._handleInputChange=e=>{let i=this._getFormElements(),s={language:this.language,contentSnippets:2,contentSnippetsLength:120},n={};this.quarkusversion&&(s.version=this.quarkusversion),this.originFilter&&(s.origin=this.originFilter);var o=0;for(let l of i)this._isInput(l)&&(l.value.length===0||l.value.length<this.minChars)||l.value&&l.value.length>0&&l.name.length>0&&(s[l.name]=l.value,n[l.name]=l.value,o++);o==0?(this._backendData=null,this._browserData=null):(this._backendData=s,this._browserData=n)};this._handleNextPage=e=>{this._page++,this._search()};this._handleQuerySuggestion=e=>{this._getFormElements().forEach(i=>{this._isInput(i)&&i.name==="q"&&(i.value=e.detail.suggestion.query)}),this._handleInputChange(e)};let e=new URLSearchParams(window.location.hash.substring(1));if(e.size>0){this._initialQueryStringPresent=!0;let i=this._getFormElements();for(let s of i){let n=e.get(s.name);n&&(s.value=n)}}}render(){return f`
  ...
  `,c([u({type:String})],_.prototype,"server",2),c([u({type:String,attribute:"min-chars"})],_.prototype,"minChars",2),c([u({type:String,attribute:"initial-timeout"})],_.prototype,"initialTimeout",2),c([u({type:String,attribute:"more-timeout"})],_.prototype,"moreTimeout",2),c([u({type:String})],_.prototype,"language",2),c([u({type:String,attribute:"quarkus-version"})],_.prototype,"quarkusversion",2),c([u({type:String,attribute:"local-search"})],_.prototype,"localSearch",2),c([u({type:String,attribute:"origin-filter"})],_.prototype,"originFilter",2),c([Y({hasChanged(e,i){return JSON.stringify(e)!==JSON.stringify(i)}})],_.prototype,"_backendData",2),_=c([V("qs-form")],_);var Re={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Oe=r=>(...t)=>({_$litDirective$:r,values:t}),dt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var tt=class extends dt{constructor(t){if(super(t),this.it=p,t.type!==Re.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===p||t==null)return this._t=void 0,this.it=t;if(t===E)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};tt.directiveName="unsafeHTML",tt.resultType=1;var j=Oe(tt);var y=class extends ${constructor(){super(...arguments);this.type="default";this.origin="quarkus";this.originsWithRelativeUrls=[]}connectedCallback(){if(this.data)for(let e in this.data)this.data.hasOwnProperty(e)&&(this[e]=this.data[e]);super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return f`
    ...
    `}relativizeUrl(){if(this.originsWithRelativeUrls.includes(this.origin)&&!this.url.startsWith("/"))try{return this.url.substring(new URL(this.url).origin.length)}catch{return this.url}else return this.url}icon(){let e=q.docs[this.type];return this._iconToSvg(e)}_renderHTML(e){return e&&(Array.isArray(e)?e.map(i=>f`<p>${this._renderHTML(i)}</p>`):j(e))}_originTitle(){return this.origin==="quarkiverse-hub"?"Quarkus extension project contributed by the community":this.origin}_originLink(){return this.origin==="quarkiverse-hub"?"https://github.com/quarkiverse":"#"}_originIcon(){let e=q.origins[this.origin==="quarkiverse-hub"?"quarkiverse":this.origin];return console.log(e),this._iconToSvg(e)}_iconToSvg(e){if(e){let i=e.match(/.*(<svg.*<\/svg>)/);if(i)return i[1].replaceAll("%23","#")}return""}};y.styles=T`
      ...
      .qs-guide .origin.quarkus {
          background-image: url('${L(q.origins.quarkus)}');
      }

      .qs-guide .origin.quarkiverse-hub {
          background-image: url('${L(q.origins.quarkiverse)}');
      }
  ...
  `,c([u({type:Object})],y.prototype,"data",2),c([u({type:String})],y.prototype,"type",2),c([u({type:String})],y.prototype,"url",2),c([u({type:String})],y.prototype,"title",2),c([u({type:String})],y.prototype,"summary",2),c([u({type:String})],y.prototype,"keywords",2),c([u({type:String})],y.prototype,"content",2),c([u({type:String})],y.prototype,"origin",2),c([u({type:String,attribute:"origins-with-relative-urls"})],y.prototype,"originsWithRelativeUrls",2),y=c([V("qs-guide")],y);var Ne=Rt(Tt());var A=class extends ${constructor(){super(...arguments);this.searchResultsTitle="";this.type="guide";this.originsWithRelativeUrls=[];this._loading=!0;this._handleScroll=e=>{if(this._loading||!this._result)return;if(!this._result.hasMoreHits){console.debug("no more hits");return}let i=this._hits.length==0?null:this._hits[this._hits.length-1];if(!i)return;let s=document.documentElement,n=s.scrollTop+s.clientHeight,o=i.offsetTop;n>=o&&(this._loading=!0,this._form.dispatchEvent(new CustomEvent(ht)))};this._handleScrollDebounced=(0,Ne.default)(this._handleScroll,100);this._handleResult=e=>{if(console.debug("Received results in qs-target: ",e.detail),this._loadingEnd(),!this._result||!e.detail||!e.detail.hits||e.detail.page===0){e.detail?.hits?document.body.classList.add("qs-has-results"):document.body.classList.remove("qs-has-results"),this._result=e.detail;return}this._result.hits=this._result.hits.concat(e.detail.hits),console.debug(`${this._result.hits.length} results in qs-target: `),this._result.hasMoreHits=e.detail.hasMoreHits};this._loadingStart=e=>{this._loading=!0,e.detail.page===0&&(this._result=void 0)};this._loadingEnd=()=>{this._loading=!1}}connectedCallback(){super.connectedCallback(),this._form=document.querySelector("qs-form"),this._form.addEventListener(P,this._handleResult),this._form.addEventListener(ut,this._loadingStart),document.addEventListener("scroll",this._handleScrollDebounced)}disconnectedCallback(){this._form.removeEventListener(P,this._handleResult),this._form.removeEventListener(ut,this._loadingStart),document.removeEventListener("scroll",this._handleScrollDebounced),super.disconnectedCallback()}render(){if(this._result?.hits){if(this._result.hits.length===0)return f`
    ...
    `}_renderHit(e){switch(this.type){case"guide":return f`
          <qs-guide class="qs-hit" .data=${e} origins-with-relative-urls=${this.originsWithRelativeUrls}></qs-guide>`}return""}_querySuggestion(){this._form.dispatchEvent(new CustomEvent(ct,{detail:{suggestion:this._result.suggestion}}))}};A.styles=T`
    
    .loading {
      background-image: url('${L(q.loading)}');
      background-repeat: no-repeat;
  ...
  `,c([u({type:String,attribute:"search-results-title"})],A.prototype,"searchResultsTitle",2),c([u({type:String})],A.prototype,"type",2),c([u({type:String,attribute:"origins-with-relative-urls"})],A.prototype,"originsWithRelativeUrls",2),c([Y()],A.prototype,"_result",2),c([Y()],A.prototype,"_loading",2),c([ie(".qs-hit")],A.prototype,"_hits",2),A=c([V("qs-target")],A);export{D as LocalSearch,ht as QS_NEXT_PAGE_EVENT,ct as QS_QUERY_SUGGESTION_EVENT,P as QS_RESULT_EVENT,ut as QS_START_EVENT,_ as QsForm,y as QsGuide,A as QsTarget};
...
lit-html/directives/unsafe-html.js:
   ...
   *)
*/
//# sourceMappingURL=/static/bundle/main-LQZYWAX4.js.map
